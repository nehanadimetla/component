...
The component I chose to make from the Flashcard Deck component. This design fits well with the interests of my life as it coincides with organization and study habits. I chose this over the MusicPlaylist and ToDoList ideas because I believe the Flashcard Deck is manageable to create over the course of the semester while still providing as an educational challenge to me. The FlashcardDeck component has many features such as shuffling, removing, and editing which I believe will cover a lot of ground in terms of conceptual material. This component additionally maps easily onto the OSU Sequence component since a flashcard deck is essentially an ordered sequence and an index.
